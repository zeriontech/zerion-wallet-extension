...
/** Em dash used as a "no value" / locked placeholder. */
const PLACEHOLDER = '—';
...
function PnlValue({
  ...
  /** Relative gain as a fraction (100% = 1). */
  relative: number;
  /** Absolute gain in the display currency. */
  absolute: number;
  currency: string;
  textKind: Kind;
}) {
...
/**
 * "All-time PnL" tab on Wallet Overview.
 * Premium users see the numbers; free users see a Premium upsell in their place.
 */
export function Pnl() {
  ...
  // Avoid flashing the upsell while we don't yet know the premium status.
