...
async function build() {
  ...
  await execAsync(
    ...
    'PLATFORM=firefox ./node_modules/.bin/parcel build src/manifest.json src/ui/hardware-wallet/ledger.html --no-content-hash --no-source-maps --dist-dir dist-firefox --cache-dir .parcel-cache-firefox'
  );
